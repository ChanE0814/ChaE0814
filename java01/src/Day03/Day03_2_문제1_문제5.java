...
public class Day03_2_문제1_문제5 {
	...
	public static void main(String[] args) {
		...
		int 정수1 = scanner.nextInt(); // int형 변수 선언 하고 입력받은 데이터를  정수로 가져와서 대입
		...
		//만약 입력받은 정수1변수가 정수2변수 보다 크면 실행 아니면 다음 조건
		else if (정수1 <정수2) System.out.println("더 큰수 :"+정수2);
		//[다음조건] 정수1변수가 정수2보다 작으면 실행 아니면 그외 
		...
		if(max < 정수5 ) { max = 정수5; } 			//만약에 max보다 정수5가 더 크면 max 교체
		...
		System.out.println("정수1입력:"); int 정수10 = scanner.nextInt();
		System.out.println("정수2입력:"); int 정수11 = scanner.nextInt();
		System.out.println("정수3입력:"); int 정수12 = scanner.nextInt();
		
		if(정수10 > 정수11) { // > : 오름차순  < : 내림차순
				//교체 [ 스왑 = 두개 변수에 데이터 교화방법 ] 
			int temp = 정수10; 	//임시변수 = 변수1 ;
			정수10 = 정수11;		//변수1 = 변수2 ; 
			정수11 = temp; 		//변수2 = 임시변수 [ temp 
		}
		...
		//문제 5 : 4개의 정수를 입력받아서 오름차순/ 내림차순 
		System.out.println("정수1입력 :"); int 정수13 = scanner.nextInt();
		...
		if (정수13 > 14) {int temp = 정수13 ; 정수13 = 정수14;  정수14 = temp; }
		if (정수13 > 15) {int temp = 정수13 ; 정수13 = 정수15; 정수15 = temp ; }
		if (정수13 > 16) {int temp = 정수13 ; 정수13 = 정수16; 정수16 = temp ; }
		
		//두번째 값 기준 으로 비교 
		
		if (정수14 > 15) {int temp = 정수14 ; 정수14 = 정수15; 정수15 =temp ; }
		if (정수14 > 16) {int temp = 정수14 ; 정수14 = 정수16; 정수16 =temp ; }
